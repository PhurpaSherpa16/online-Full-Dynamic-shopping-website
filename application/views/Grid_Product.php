								...
								foreach ($pdata->result() as $row) {
									?>
										<div id="card" class=" col-lg-3 col-md-4 col-sm-6 col-xs-12">
 										<div class="imgBx">
 											<a href="<?php echo base_url();?>Auth/product_view?pid=<?php echo $row->id; ?>"><img id="img" class="img-responsive" src="<?php echo base_url();?>assets/images/products/<?php echo $row->image;?>" alt="image">
 										</div>
 											<ul>
 											<li>View</a></li>
 											</ul>
